...
async function fetchKpiData(
  ...
  return [
    ...
    { metric: "conversions", label: "Conversions", current: currentKpis.conversions, comparison: compKpis.conversions, delta_pct: computeDelta(currentKpis.conversions, compKpis.conversions), format: "number" },
    { metric: "estimated_roa", label: "Est. ROA", current: currentKpis.estimated_roa, comparison: compKpis.estimated_roa, delta_pct: computeDelta(currentKpis.estimated_roa, compKpis.estimated_roa), format: "multiplier" },
  ];
}
